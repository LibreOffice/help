...
<xsl:when test="$src1='cmd/lc_masterpage.png'"><xsl:text>cmd/lc_slidemasterpage.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_pagemode.png'"><xsl:text>cmd/sc_normalmultipanegui.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_pagemode.png'"><xsl:text>cmd/lc_normalmultipanegui.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/basicideappear.png'"><xsl:text>cmd/32/toolsmacroedit.png</xsl:text></xsl:when>
