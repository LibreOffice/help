...
<xsl:when test="$src1='cmd/32/charttitlemenu.png'"><xsl:text>cmd/32/toggletitle.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/diagramaxisall.png'"><xsl:text>cmd/32/diagramaxisxyz.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/diagramaxismenu.png'"><xsl:text>cmd/32/diagramaxis.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/diagramgridmenu.png'"><xsl:text>cmd/32/togglegridhorizontal.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertmenuaxes.png'"><xsl:text>cmd/32/diagramaxis.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertmenugrids.png'"><xsl:text>cmd/32/togglegridhorizontal.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertmenulegend.png'"><xsl:text>cmd/32/legend.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_charttitlemenu.png'"><xsl:text>cmd/lc_toggletitle.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_diagramaxisall.png'"><xsl:text>cmd/lc_diagramaxisxyz.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_diagramaxismenu.png'"><xsl:text>cmd/lc_diagramaxis.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_diagramgridmenu.png'"><xsl:text>cmd/lc_togglegridhorizontal.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_insertmenulegend.png'"><xsl:text>cmd/lc_legend.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/adddatefield.png'"><xsl:text>cmd/32/datefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/addons.png'"><xsl:text>cmd/32/insertplugin.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/addprintarea.png'"><xsl:text>cmd/32/inserttable.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/addtable.png'"><xsl:text>cmd/32/dbnewtable.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_addtable.png'"><xsl:text>cmd/lc_dbnewtable.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_addtable.png'"><xsl:text>cmd/sc_dbnewtable.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/autoformatmenu.png'"><xsl:text>cmd/32/autocorrectdlg.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/showinlinetooltips.png'"><xsl:text>cmd/32/editannotation.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/updatemenu.png'"><xsl:text>cmd/32/reload.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_autoformatmenu.png'"><xsl:text>cmd/lc_autocorrectdlg.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_showinlinetooltips.png'"><xsl:text>cmd/lc_editannotation.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_updatemenu.png'"><xsl:text>cmd/lc_reload.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_autoformatmenu.png'"><xsl:text>cmd/sc_autocorrectdlg.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/changesmenu.png'"><xsl:text>cmd/32/trackchanges.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/charactermenu.png'"><xsl:text>cmd/32/fontdialog.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/fieldmenu.png'"><xsl:text>cmd/32/addfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/graphicmenu.png'"><xsl:text>cmd/32/avmediaplayer.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertauthorfield.png'"><xsl:text>cmd/32/dbviewaliases.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertavmedia.png'"><xsl:text>cmd/32/avmediaplayer.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertctrl.png'"><xsl:text>cmd/32/inserttable.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertcurrencyfield.png'"><xsl:text>cmd/32/currencyfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertdatefield.png'"><xsl:text>cmd/32/datefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertedit.png'"><xsl:text>cmd/32/edit.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertfield.png'"><xsl:text>cmd/32/addfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertfilecontrol.png'"><xsl:text>cmd/32/filecontrol.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertfilefield.png'"><xsl:text>cmd/32/filefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertformattedfield.png'"><xsl:text>cmd/32/formattedfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertformcheck.png'"><xsl:text>cmd/32/checkbox.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertformcombo.png'"><xsl:text>cmd/32/combobox.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertformlist.png'"><xsl:text>cmd/32/listbox.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertformmenu.png'"><xsl:text>cmd/32/choosecontrols.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertformradio.png'"><xsl:text>cmd/32/radiobutton.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertformspin.png'"><xsl:text>cmd/32/spinbutton.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertformula.png'"><xsl:text>cmd/32/dbviewfunctions.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertformvscroll.png'"><xsl:text>cmd/32/scrollbar.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertframeinteract.png'"><xsl:text>cmd/32/insertframe.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertframeinteractnocolumns.png'"><xsl:text>cmd/32/insertframe.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertimagecontrol.png'"><xsl:text>cmd/32/insertgraphic.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertlistbox.png'"><xsl:text>cmd/32/listbox.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertnumericfield.png'"><xsl:text>cmd/32/numberformatstandard.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertobjectchart.png'"><xsl:text>cmd/32/drawchart.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertobjectdialog.png'"><xsl:text>cmd/32/insertobject.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertobjectstarmath.png'"><xsl:text>cmd/32/insertmath.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertpatternfield.png'"><xsl:text>cmd/32/patternfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertpushbutton.png'"><xsl:text>cmd/32/pushbutton.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertrowbreak.png'"><xsl:text>cmd/32/insertpagebreak.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/inserttextframe.png'"><xsl:text>cmd/32/insertframe.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/inserttimefield.png'"><xsl:text>cmd/32/timefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insobjctrl.png'"><xsl:text>cmd/32/newdoc.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/numberingmenu.png'"><xsl:text>cmd/32/outlinebullet.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/numericfield.png'"><xsl:text>cmd/32/numberformatstandard.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/paragraphmenu.png'"><xsl:text>cmd/32/paragraphdialog.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/shapesmenu.png'"><xsl:text>cmd/32/insertdraw.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/tracechangemode.png'"><xsl:text>cmd/32/trackchanges.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/viewtrackchanges.png'"><xsl:text>cmd/32/showtrackedchanges.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_changesmenu.png'"><xsl:text>cmd/lc_trackchanges.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_charactermenu.png'"><xsl:text>cmd/lc_fontdialog.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_fieldmenu.png'"><xsl:text>cmd/lc_addfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_graphicmenu.png'"><xsl:text>cmd/lc_avmediaplayer.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insert.png'"><xsl:text>cmd/lc_insertspreadsheet.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_insertcurrencyfield.png'"><xsl:text>cmd/lc_currencyfield.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_insertfilecontrol.png'"><xsl:text>cmd/lc_filecontrol.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertfilefield.png'"><xsl:text>cmd/lc_filefield.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_insertformmenu.png'"><xsl:text>cmd/lc_choosecontrols.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_insertobjectdialog.png'"><xsl:text>cmd/lc_insertobject.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_numberingmenu.png'"><xsl:text>cmd/lc_outlinebullet.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_numericfield.png'"><xsl:text>cmd/lc_numberformatstandard.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_paragraphmenu.png'"><xsl:text>cmd/lc_paragraphdialog.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_shapesmenu.png'"><xsl:text>cmd/lc_insertdraw.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_viewtrackchanges.png'"><xsl:text>cmd/lc_addwatch.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_fieldmenu.png'"><xsl:text>cmd/sc_addfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_graphicmenu.png'"><xsl:text>cmd/sc_avmediaplayer.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_insert.png'"><xsl:text>cmd/sc_insertspreadsheet.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_insertcurrencyfield.png'"><xsl:text>cmd/sc_currencyfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_insertdatefield.png'"><xsl:text>cmd/sc_datefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_insertedit.png'"><xsl:text>cmd/sc_edit.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_insertfield.png'"><xsl:text>cmd/sc_addfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_insertfilecontrol.png'"><xsl:text>cmd/sc_filecontrol.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_insertfilefield.png'"><xsl:text>cmd/sc_filefield.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_insertformmenu.png'"><xsl:text>cmd/sc_choosecontrols.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_insertobjectdialog.png'"><xsl:text>cmd/sc_insertobject.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_shapesmenu.png'"><xsl:text>cmd/sc_insertdraw.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_changesmenu.png'"><xsl:text>cmd/sc_trackchanges.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_changesmenu.png'"><xsl:text>cmd/lc_trackchanges.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/adjust.png'"><xsl:text>cmd/32/zoomoptimal.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/previewzoom.png'"><xsl:text>cmd/32/zoom.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/view100.png'"><xsl:text>cmd/32/zoom100percent.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/zoomminus.png'"><xsl:text>cmd/32/zoomout.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/zoommode.png'"><xsl:text>cmd/32/zoomoptimal.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/zoomplus.png'"><xsl:text>cmd/32/zoomin.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/zoomtoolbox.png'"><xsl:text>cmd/32/zoom.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_adjust.png'"><xsl:text>cmd/lc_zoomoptimal.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_previewzoom.png'"><xsl:text>cmd/lc_zoom.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_view100.png'"><xsl:text>cmd/lc_zoom100percent.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_zoomtoolbox.png'"><xsl:text>cmd/lc_zoom.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_adjust.png'"><xsl:text>cmd/sc_zoomoptimal.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_previewzoom.png'"><xsl:text>cmd/sc_zoom.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_view100.png'"><xsl:text>cmd/sc_zoom100percent.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_zoomtoolbox.png'"><xsl:text>cmd/sc_zoom.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/savebasicas.png'"><xsl:text>cmd/32/saveas.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/savegraphic.png'"><xsl:text>cmd/32/save.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/recsave.png'"><xsl:text>cmd/32/save.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/doubleclicktextedit.png'"><xsl:text>cmd/32/pickthrough.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/drawtext.png'"><xsl:text>cmd/32/text.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/fontheight.png'"><xsl:text>cmd/32/scaletext.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/fontworkcharacterspacingfloater.png'"><xsl:text>cmd/32/spacing.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/textfittosizetool.png'"><xsl:text>cmd/32/text_marquee.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/texttoolbox.png'"><xsl:text>cmd/32/text.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/convertinto3dlathefast.png'"><xsl:text>cmd/32/convertinto3dlathe.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/objects3dtoolbox.png'"><xsl:text>cmd/32/cube.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/view3d.png'"><xsl:text>cmd/32/cube.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/optionstreedialog.png'"><xsl:text>cmd/32/controlproperties.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/anchormenu.png'"><xsl:text>cmd/32/toggleanchortype.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/conditionalformatmenu.png'"><xsl:text>cmd/32/colorscaleformatdialog.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/formatbulletsmenu.png'"><xsl:text>cmd/32/defaultbullet.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/formatframemenu.png'"><xsl:text>cmd/32/framedialog.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/formatimagemenu.png'"><xsl:text>cmd/32/graphic.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/formatspacingmenu.png'"><xsl:text>cmd/32/spacepara15.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/formattextmenu.png'"><xsl:text>cmd/32/color.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/textalign.png'"><xsl:text>cmd/32/alignblock.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_formatbulletsmenu.png'"><xsl:text>cmd/lc_defaultbullet.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_formatframemenu.png'"><xsl:text>cmd/lc_formatline.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_formatimagemenu.png'"><xsl:text>cmd/lc_graphicdialog.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_formatspacingmenu.png'"><xsl:text>cmd/lc_spacepara15.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_formattextmenu.png'"><xsl:text>cmd/lc_color.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_textalign.png'"><xsl:text>cmd/lc_alignblock.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_anchormenu.png'"><xsl:text>cmd/sc_toggleanchortype.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_formatimagemenu.png'"><xsl:text>cmd/sc_graphicdialog.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/openurl.png'"><xsl:text>cmd/32/browseview.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/webhtml.png'"><xsl:text>cmd/32/browseview.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/hscroll.png'"><xsl:text>cmd/32/hscrollbar.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertformhscroll.png'"><xsl:text>cmd/32/hscrollbar.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/scrollbarmenu.png'"><xsl:text>cmd/32/scrollbar.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/vscroll.png'"><xsl:text>cmd/32/scrollbar.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/vscrollbar.png'"><xsl:text>cmd/32/scrollbar.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_hscroll.png'"><xsl:text>cmd/lc_hscrollbar.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertformhscroll.png'"><xsl:text>cmd/lc_hscrollbar.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_scrollbarmenu.png'"><xsl:text>cmd/lc_scrollbar.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_vscroll.png'"><xsl:text>cmd/lc_scrollbar.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_vscrollbar.png'"><xsl:text>cmd/lc_scrollbar.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_hscroll.png'"><xsl:text>cmd/sc_hscrollbar.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_insertformhscroll.png'"><xsl:text>cmd/sc_hscrollbar.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_scrollbarmenu.png'"><xsl:text>cmd/sc_scrollbar.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_vscroll.png'"><xsl:text>cmd/sc_scrollbar.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_vscrollbar.png'"><xsl:text>cmd/sc_scrollbar.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/languagemenu.png'"><xsl:text>cmd/32/managelanguage.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_languagemenu.png'"><xsl:text>cmd/lc_managelanguage.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_languagemenu.png'"><xsl:text>cmd/sc_managelanguage.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/acceptchanges.png'"><xsl:text>cmd/32/accepttrackedchanges.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/accepttracedchange.png'"><xsl:text>cmd/32/accepttrackedchange.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/commentchange.png'"><xsl:text>cmd/32/commentchangetracking.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/deleteallnotes.png'"><xsl:text>cmd/32/deleteallannotation.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/deletecomment.png'"><xsl:text>cmd/32/deleteannotation.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/deletenote.png'"><xsl:text>cmd/32/deleteannotation.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertannotation.png'"><xsl:text>cmd/32/shownote.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/notevisible.png'"><xsl:text>cmd/32/shownote.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/showallnotes.png'"><xsl:text>cmd/32/showannotations.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/showchanges.png'"><xsl:text>cmd/32/addwatch.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_acceptchanges.png'"><xsl:text>cmd/lc_accepttrackedchanges.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_accepttracedchange.png'"><xsl:text>cmd/lc_accepttrackedchange.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_deletecomment.png'"><xsl:text>cmd/lc_deleteannotation.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_deletenote.png'"><xsl:text>cmd/lc_deleteannotation.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertannotation.png'"><xsl:text>cmd/lc_shownote.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_notevisible.png'"><xsl:text>cmd/lc_shownote.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_showallnotes.png'"><xsl:text>cmd/lc_showannotations.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_showchanges.png'"><xsl:text>cmd/lc_addwatch.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_acceptchanges.png'"><xsl:text>cmd/sc_accepttrackedchanges.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_accepttracedchange.png'"><xsl:text>cmd/sc_accepttrackedchange.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_deletecomment.png'"><xsl:text>cmd/sc_deleteannotation.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_insertannotation.png'"><xsl:text>cmd/sc_shownote.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_notevisible.png'"><xsl:text>cmd/sc_shownote.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_showallnotes.png'"><xsl:text>cmd/sc_showannotations.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_showchanges.png'"><xsl:text>cmd/sc_addwatch.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/templatemenu.png'"><xsl:text>cmd/32/adddirect.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_templatemenu.png'"><xsl:text>cmd/lc_adddirect.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_templatemenu.png'"><xsl:text>cmd/sc_adddirect.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/customanimation.png'"><xsl:text>cmd/32/animationobjects.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/datastreamsplay.png'"><xsl:text>cmd/32/runbasic.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/datastreamsstop.png'"><xsl:text>cmd/32/basicstop.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/alignhorizontalceter.png'"><xsl:text>cmd/32/alignhorizontalcenter.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/alignvcenter.png'"><xsl:text>cmd/32/alignverticalcenter.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/objectalign.png'"><xsl:text>cmd/32/objectalignleft.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/sectionalignbottom.png'"><xsl:text>cmd/32/aligndown.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/sectionalignleft.png'"><xsl:text>cmd/32/objectalignleft.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/sectionalignright.png'"><xsl:text>cmd/32/objectalignright.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/sectionaligntop.png'"><xsl:text>cmd/32/alignup.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_alignhorizontalceter.png'"><xsl:text>cmd/lc_alignhorizontalcenter.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/colorview.png'"><xsl:text>cmd/32/graphicfilterinvert.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/grafinvert.png'"><xsl:text>cmd/32/graphicfilterinvert.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/grafmode.png'"><xsl:text>cmd/32/graphicdialog.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/graphicfilterposter.png'"><xsl:text>cmd/32/graphicdialog.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/objecttitledescription.png'"><xsl:text>cmd/32/insertcaptiondialog.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_flowchartshapes.png'"><xsl:text>cmd/sc_flowchartshapes.flowchart-document.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/openfromwriter.png'"><xsl:text>cmd/32/open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/openfromcalc.png'"><xsl:text>cmd/32/open.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/mergedocument.png'"><xsl:text>cmd/32/mergedocuments.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/attributepagesize.png'"><xsl:text>cmd/32/ruler.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_attributepagesize.png'"><xsl:text>cmd/lc_ruler.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_attributepagesize.png'"><xsl:text>cmd/sc_ruler.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/previewprintoptions.png'"><xsl:text>cmd/32/printpreview.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/printpagepreview.png'"><xsl:text>cmd/32/printpreview.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/sendfax.png'"><xsl:text>cmd/32/print.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/editprintarea.png'"><xsl:text>cmd/32/editdoc.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/deletecell.png'"><xsl:text>cmd/32/delete.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/deleteprintarea.png'"><xsl:text>cmd/32/delete.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/deleterecord.png'"><xsl:text>cmd/32/delete.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/dbformopen.png'"><xsl:text>cmd/32/open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/dbqueryopen.png'"><xsl:text>cmd/32/open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/dbreportopen.png'"><xsl:text>cmd/32/open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/dbtableopen.png'"><xsl:text>cmd/32/open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertdoc.png'"><xsl:text>cmd/32/open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/newrecord.png'"><xsl:text>cmd/32/open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/open_h.png'"><xsl:text>cmd/32/open.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_open_h.png'"><xsl:text>cmd/lc_open.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/importfromfile.png'"><xsl:text>cmd/32/dataimport.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/commontaskbarvisible.png'"><xsl:text>cmd/32/autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/dbformopen.png'"><xsl:text>cmd/32/open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/dbnewformautopilot.png'"><xsl:text>cmd/32/autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/dbnewqueryautopilot.png'"><xsl:text>cmd/32/autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/dbnewreportautopilot.png'"><xsl:text>cmd/32/autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/dbnewtableautopilot.png'"><xsl:text>cmd/32/autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/graphicfiltertoolbox.png'"><xsl:text>cmd/32/autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertdoc.png'"><xsl:text>cmd/32/open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/newarrangement.png'"><xsl:text>cmd/32/autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/newrecord.png'"><xsl:text>cmd/32/open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/usewizards.png'"><xsl:text>cmd/32/autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_commontaskbarvisible.png'"><xsl:text>cmd/lc_autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_dbformopen.png'"><xsl:text>cmd/lc_open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_dbnewformautopilot.png'"><xsl:text>cmd/lc_autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_dbnewqueryautopilot.png'"><xsl:text>cmd/lc_autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_dbnewreportautopilot.png'"><xsl:text>cmd/lc_autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_dbnewtableautopilot.png'"><xsl:text>cmd/lc_autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_graphicfiltertoolbox.png'"><xsl:text>cmd/lc_autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertdoc.png'"><xsl:text>cmd/lc_open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_newarrangement.png'"><xsl:text>cmd/lc_autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_newrecord.png'"><xsl:text>cmd/lc_open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_usewizards.png'"><xsl:text>cmd/lc_autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_commontaskbarvisible.png'"><xsl:text>cmd/sc_autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_dbformopen.png'"><xsl:text>cmd/sc_open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_dbnewformautopilot.png'"><xsl:text>cmd/sc_autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_dbnewqueryautopilot.png'"><xsl:text>cmd/sc_autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_dbnewreportautopilot.png'"><xsl:text>cmd/sc_autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_dbnewtableautopilot.png'"><xsl:text>cmd/sc_autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_dbqueryopen.png'"><xsl:text>cmd/sc_open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_dbreportopen.png'"><xsl:text>cmd/sc_open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_dbtableopen.png'"><xsl:text>cmd/sc_open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_graphicfiltertoolbox.png'"><xsl:text>cmd/sc_autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_insertdoc.png'"><xsl:text>cmd/sc_open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_newarrangement.png'"><xsl:text>cmd/sc_autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_newrecord.png'"><xsl:text>cmd/sc_open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_open_h.png'"><xsl:text>cmd/sc_open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_usewizards.png'"><xsl:text>cmd/sc_autopilotmenu.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/autofilter.png'"><xsl:text>cmd/32/datafilterautofilter.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/filtercrit.png'"><xsl:text>cmd/32/datafilterstandardfilter.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/formfilter.png'"><xsl:text>cmd/32/datafilterspecialfilter.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/formfilterexecute.png'"><xsl:text>cmd/32/datafilterstandardfilter.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/removefilter.png'"><xsl:text>cmd/32/removefiltersort.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/bulletliststyle.png'"><xsl:text>cmd/32/defaultbullet.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/defaultparastyle.png'"><xsl:text>cmd/32/controlcodes.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/numberliststyle.png'"><xsl:text>cmd/32/defaultnumbering.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_numberliststyle.png'"><xsl:text>cmd/lc_defaultnumbering.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_numberliststyle.png'"><xsl:text>cmd/sc_defaultnumbering.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/groupmenu.png'"><xsl:text>cmd/32/formatgroup.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/leaveallgroups.png'"><xsl:text>cmd/32/leavegroup.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_groupmenu.png'"><xsl:text>cmd/lc_formatgroup.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_leaveallgroups.png'"><xsl:text>cmd/lc_leavegroup.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_groupmenu.png'"><xsl:text>cmd/sc_formatgroup.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_leaveallgroups.png'"><xsl:text>cmd/sc_leavegroup.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/recundo.png'"><xsl:text>cmd/32/undo.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/bezieredge.png'"><xsl:text>cmd/32/bezierappend.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/addname.png'"><xsl:text>cmd/32/label.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_addname.png'"><xsl:text>cmd/lc_label.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_addname.png'"><xsl:text>cmd/sc_label.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/clickchangerotation.png'"><xsl:text>cmd/32/toggleobjectrotatemode.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/fieldnames.png'"><xsl:text>cmd/32/addfield.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/dsbeditdoc.png'"><xsl:text>cmd/32/editdoc.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/quickedit.png'"><xsl:text>cmd/32/editdoc.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/renamemasterpage.png'"><xsl:text>cmd/32/slidemasterpage.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/closewin.png'"><xsl:text>cmd/32/closepreview.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/exitsearch.png'"><xsl:text>cmd/32/closepreview.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/closedocs.png'"><xsl:text>cmd/32/closedoc.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/no.png'"><xsl:text>cmd/32/cancel.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/removetableof.png'"><xsl:text>cmd/32/cancel.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_no.png'"><xsl:text>cmd/lc_cancel.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_removetableof.png'"><xsl:text>cmd/lc_cancel.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/protecttracechangemode.png'"><xsl:text>cmd/32/protect.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/insertobjctrl.png'"><xsl:text>cmd/32/drawchart.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/modifypage.png'"><xsl:text>cmd/32/pagedialog.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/outlinedown.png'"><xsl:text>cmd/32/movedown.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/outlineup.png'"><xsl:text>cmd/32/moveup.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/shapeslinemenu.png'"><xsl:text>cmd/32/line.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/xlinestyle.png'"><xsl:text>cmd/32/linestyle.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_shapeslinemenu.png'"><xsl:text>cmd/lc_line.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/mailmergefirstentry.png'"><xsl:text>cmd/32/firstrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/mailmergelastentry.png'"><xsl:text>cmd/32/lastrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/mailmergenextentry.png'"><xsl:text>cmd/32/nextrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/mailmergepreventry.png'"><xsl:text>cmd/32/prevrecord.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/arrowstoolbox.png'"><xsl:text>cmd/32/linearrowend.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/browsebackward.png'"><xsl:text>cmd/32/prevrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/navigateback.png'"><xsl:text>cmd/32/prevrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/pageup.png'"><xsl:text>cmd/32/prevrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/previouspage.png'"><xsl:text>cmd/32/prevrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/previoustrackedchange.png'"><xsl:text>cmd/32/prevrecord.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/navigateforward.png'"><xsl:text>cmd/32/nextrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/nextpage.png'"><xsl:text>cmd/32/nextrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/nexttrackedchange.png'"><xsl:text>cmd/32/nextrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/pagedown.png'"><xsl:text>cmd/32/nextrecord.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/gotoend.png'"><xsl:text>cmd/32/lastrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/gotoendofdoc.png'"><xsl:text>cmd/32/lastrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/lastpage.png'"><xsl:text>cmd/32/lastrecord.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/gotostartofdoc.png'"><xsl:text>cmd/32/firstrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/gotostartoftable.png'"><xsl:text>cmd/32/firstrecord.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/hyperlinkdialog.png'"><xsl:text>cmd/32/inserthyperlink.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/spellingandgrammardialog.png'"><xsl:text>cmd/32/spelling.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/spelldialog.png'"><xsl:text>cmd/32/spelling.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/backgroundpatterncontroller.png'"><xsl:text>cmd/32/backgroundcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/characterbackgroundpattern.png'"><xsl:text>cmd/32/backcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/fillcolor.png'"><xsl:text>cmd/32/backgroundcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/fillstyle.png'"><xsl:text>cmd/32/backgroundcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/fontcolor.png'"><xsl:text>cmd/32/color.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/formatarea.png'"><xsl:text>cmd/32/backgroundcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/tablecellbackgroundcolor.png'"><xsl:text>cmd/32/backgroundcolor.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_fillcolor.png'"><xsl:text>cmd/lc_backgroundcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_fillstyle.png'"><xsl:text>cmd/lc_backgroundcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_fontcolor.png'"><xsl:text>cmd/lc_color.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_formatarea.png'"><xsl:text>cmd/lc_backgroundcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_tablecellbackgroundcolor.png'"><xsl:text>cmd/lc_backgroundcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_backgroundpatterncontroller.png'"><xsl:text>cmd/sc_backgroundcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_characterbackgroundpattern.png'"><xsl:text>cmd/sc_backcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_fillcolor.png'"><xsl:text>cmd/sc_backgroundcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_fillstyle.png'"><xsl:text>cmd/sc_backgroundcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_fontcolor.png'"><xsl:text>cmd/sc_color.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_formatarea.png'"><xsl:text>cmd/sc_backgroundcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_tablecellbackgroundcolor.png'"><xsl:text>cmd/sc_backgroundcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/centerpara.png'"><xsl:text>cmd/32/alignhorizontalcenter.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/fontworkalignmentfloater.png'"><xsl:text>cmd/32/alignhorizontalcenter.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/justifypara.png'"><xsl:text>cmd/32/alignblock.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/leftpara.png'"><xsl:text>cmd/32/alignleft.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/rightpara.png'"><xsl:text>cmd/32/alignright.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/sidebarmenu.png'"><xsl:text>cmd/32/sidebar.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/cellvertbottom.png'"><xsl:text>cmd/32/alignbottom.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/cellvertcenter.png'"><xsl:text>cmd/32/alignverticalcenter.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/cellverttop.png'"><xsl:text>cmd/32/aligntop.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/commonalignbottom.png'"><xsl:text>cmd/32/alignbottom.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/commonalignhorizontalcenter.png'"><xsl:text>cmd/32/alignhorizontalcenter.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/commonalignjustified.png'"><xsl:text>cmd/32/alignblock.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/commonalignleft.png'"><xsl:text>cmd/32/alignleft.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/commonalignright.png'"><xsl:text>cmd/32/alignright.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/commonaligntop.png'"><xsl:text>cmd/32/aligntop.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/commonalignverticalcenter.png'"><xsl:text>cmd/32/alignverticalcenter.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/linespacing.png'"><xsl:text>cmd/32/spacepara15.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/cellcontentsmenu.png'"><xsl:text>cmd/32/calculate.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/datapilotmenu.png'"><xsl:text>cmd/32/datadatapilotrun.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/functionbox.png'"><xsl:text>cmd/32/dbviewfunctions.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/functiondialog.png'"><xsl:text>cmd/32/dbviewfunctions.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertcolumnsmenu.png'"><xsl:text>cmd/32/insertcolumns.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertrowsmenu.png'"><xsl:text>cmd/32/insertrows.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/sheetcommentmenu.png'"><xsl:text>cmd/32/showannotations.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_cellcontentsmenu.png'"><xsl:text>cmd/lc_calculate.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_datapilotmenu.png'"><xsl:text>cmd/lc_datadatapilotrun.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_insertcolumnsmenu.png'"><xsl:text>cmd/lc_insertcolumns.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertrowsmenu.png'"><xsl:text>cmd/lc_insertrows.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_sheetcommentmenu.png'"><xsl:text>cmd/lc_showannotations.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/insertcurrentdate.png'"><xsl:text>cmd/32/datefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertcurrenttime.png'"><xsl:text>cmd/32/timefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertobjectchartfromfile.png'"><xsl:text>cmd/32/open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/pageformatdialog.png'"><xsl:text>cmd/32/pagedialog.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/basicshapes.ellipse.png'"><xsl:text>cmd/32/ellipse.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/basicshapes.png'"><xsl:text>cmd/32/basicshapes.diamond.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/basicshapes.rectangle.png'"><xsl:text>cmd/32/rect.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/ellipsetoolbox.png'"><xsl:text>cmd/32/ellipse.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/linetoolbox.png'"><xsl:text>cmd/32/freeline_unfilled.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/rectangletoolbox.png'"><xsl:text>cmd/32/rect.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_linetoolbox.png'"><xsl:text>cmd/lc_freeline_unfilled.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_linetoolbox.png'"><xsl:text>cmd/sc_freeline_unfilled.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_insertobjectchartfromfile.png'"><xsl:text>cmd/sc_open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_pageformatdialog.png'"><xsl:text>cmd/sc_pagedialog.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/datafilterhideautofilter.png'"><xsl:text>cmd/32/removefiltersort.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/dataproviderrefresh.png'"><xsl:text>cmd/32/calculate.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/headerandfooter.png'"><xsl:text>cmd/32/editheaderandfooter.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertheaderfootermenu.png'"><xsl:text>cmd/32/editheaderandfooter.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertsignatureline.png'"><xsl:text>cmd/32/signaturelinedialog.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/recalcpivottable.png'"><xsl:text>cmd/32/calculate.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_insertheaderfootermenu.png'"><xsl:text>cmd/lc_editheaderandfooter.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertsignatureline.png'"><xsl:text>cmd/lc_signaturelinedialog.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/apply.png'"><xsl:text>cmd/32/ok.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/yes.png'"><xsl:text>cmd/32/ok.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/movepagedown.png'"><xsl:text>cmd/32/downsearch.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/movepageup.png'"><xsl:text>cmd/32/upsearch.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/findbar.png'"><xsl:text>cmd/32/recsearch.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/scrolltonext.png'"><xsl:text>cmd/32/downsearch.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/scrolltoprevious.png'"><xsl:text>cmd/32/upsearch.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/exporttoepub.png'"><xsl:text>cmd/32/exportdirecttoepub.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/exporttopdf.png'"><xsl:text>cmd/32/exportdirecttopdf.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/basicshapes.frame.png'"><xsl:text>cmd/32/rect_unfilled.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/basicshapes.quadrat.png'"><xsl:text>cmd/32/square.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/flowchartshapes.flowchart-process.png'"><xsl:text>cmd/32/square.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/ordercrit.png'"><xsl:text>cmd/32/datasort.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/sortdown.png'"><xsl:text>cmd/32/sortdescending.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/sortup.png'"><xsl:text>cmd/32/sortascending.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/tablesort.png'"><xsl:text>cmd/32/sortascending.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_ordercrit.png'"><xsl:text>cmd/lc_datasort.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_ordercrit.png'"><xsl:text>cmd/sc_datasort.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/sourceview.png'"><xsl:text>cmd/32/symbolshapes.brace-pair.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/formatselection.png'"><xsl:text>cmd/32/formproperties.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/hyphenation.png'"><xsl:text>cmd/32/hyphenate.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/numberformatcurrency.png'"><xsl:text>cmd/32/currencyfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/numberformatcurrencysimple.png'"><xsl:text>cmd/32/currencyfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_numberformatcurrency.png'"><xsl:text>cmd/lc_currencyfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_numberformatcurrencysimple.png'"><xsl:text>cmd/lc_currencyfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_numberformatcurrency.png'"><xsl:text>cmd/sc_currencyfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_numberformatcurrencysimple.png'"><xsl:text>cmd/sc_currencyfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/fontworkshapetype.png'"><xsl:text>cmd/32/fontwork.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/rulermenu.png'"><xsl:text>cmd/32/ruler.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/showruler.png'"><xsl:text>cmd/32/ruler.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/outputqualitycolor.png'"><xsl:text>cmd/32/insertgraphic.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/inputlinevisible.png'"><xsl:text>cmd/32/dbviewfunctions.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/grid.png'"><xsl:text>cmd/32/insertspreadsheet.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/gridmenu.png'"><xsl:text>cmd/32/gridvisible.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertgridcontrol.png'"><xsl:text>cmd/32/insertspreadsheet.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_grid.png'"><xsl:text>cmd/lc_insertspreadsheet.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_gridmenu.png'"><xsl:text>cmd/lc_gridvisible.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertgridcontrol.png'"><xsl:text>cmd/lc_insertspreadsheet.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_grid.png'"><xsl:text>cmd/sc_insertspreadsheet.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_gridmenu.png'"><xsl:text>cmd/sc_gridvisible.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_insertgridcontrol.png'"><xsl:text>cmd/sc_insertspreadsheet.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/rulerrows.png'"><xsl:text>cmd/32/extrusiontiltleft.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/rulerrowsvertical.png'"><xsl:text>cmd/32/extrusiontiltright.png</xsl:text></xsl:when>
<xsl:when test="$src1='ccmd/lc_rulerrows.png'"><xsl:text>cmd/lc_extrusiontiltleft.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/diaauto.png'"><xsl:text>cmd/32/dia.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/editstyled.png'"><xsl:text>cmd/32/editstyle.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/loadstyles.png'"><xsl:text>cmd/32/open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/viewsidebarstyles.png'"><xsl:text>cmd/32/designerdialog.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/outlineleft.png'"><xsl:text>cmd/32/decrementindent.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/outlineright.png'"><xsl:text>cmd/32/decrementlevel.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/indexesmenu.png'"><xsl:text>cmd/32/insertindexesentry.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertfootnotesmenu.png'"><xsl:text>cmd/32/insertfootnote.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_indexesmenu.png'"><xsl:text>cmd/lc_insertindexesentry.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertfootnotesmenu.png'"><xsl:text>cmd/lc_insertfootnote.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/fliphorizontal.png'"><xsl:text>cmd/32/mirror.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/flipmenu.png'"><xsl:text>cmd/32/mirror.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/flipvertical.png'"><xsl:text>cmd/32/mirrorvert.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/mirrorhorz.png'"><xsl:text>cmd/32/mirror.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/objectmirrorhorizontal.png'"><xsl:text>cmd/32/mirror.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/objectmirrorvertical.png'"><xsl:text>cmd/32/mirrorvert.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_fliphorizontal.png'"><xsl:text>cmd/lc_mirror.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_flipmenu.png'"><xsl:text>cmd/lc_mirror.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_flipvertical.png'"><xsl:text>cmd/lc_mirrorvert.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_mirrorhorz.png'"><xsl:text>cmd/lc_mirror.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/connectorcircles.png'"><xsl:text>cmd/32/connector.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/connectorcurvecircles.png'"><xsl:text>cmd/32/connectorcurve.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/connectorlinecircles.png'"><xsl:text>cmd/32/connectorline.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/connectorlinescircles.png'"><xsl:text>cmd/32/connector.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/connectortoolbox.png'"><xsl:text>cmd/32/connector.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/numberformattime.png'"><xsl:text>cmd/32/timefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/rehearsetimings.png'"><xsl:text>cmd/32/diatime.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_numberformattime.png'"><xsl:text>cmd/lc_timefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_rehearsetimings.png'"><xsl:text>cmd/lc_diatime.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_numberformattime.png'"><xsl:text>cmd/sc_timefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_rehearsetimings.png'"><xsl:text>cmd/sc_diatime.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/arrangeframemenu.png'"><xsl:text>cmd/32/bringtofront.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/arrangemenu.png'"><xsl:text>cmd/32/bringtofront.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/setobjecttobackground.png'"><xsl:text>cmd/32/sendtoback.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/setobjecttoforeground.png'"><xsl:text>cmd/32/bringtofront.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_arrangeframemenu.png'"><xsl:text>cmd/lc_bringtofront.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_arrangemenu.png'"><xsl:text>cmd/lc_bringtofront.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/fieldmenu.png'"><xsl:text>cmd/32/insertfieldctrl.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertcell.png'"><xsl:text>cmd/32/insertcellsright.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertrowsmenu.png'"><xsl:text>cmd/32/insertrows.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/mergecellsmenu.png'"><xsl:text>cmd/32/togglemergecells.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/numberformatmenu.png'"><xsl:text>cmd/32/numberformatstandard.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/printrangesmenu.png'"><xsl:text>cmd/32/defineprintarea.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_fieldmenu.png'"><xsl:text>cmd/lc_insertfieldctrl.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertcell.png'"><xsl:text>cmd/lc_insertcellsright.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertrowsmenu.png'"><xsl:text>cmd/lc_insertrows.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_mergecellsmenu.png'"><xsl:text>cmd/lc_togglemergecells.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_numberformatmenu.png'"><xsl:text>cmd/lc_numberformatstandard.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_printrangesmenu.png'"><xsl:text>cmd/lc_defineprintarea.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/draw.png'"><xsl:text>cmd/32/reload.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/refresh.png'"><xsl:text>cmd/32/reload.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/refreshformcontrol.png'"><xsl:text>cmd/32/reload.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/repaginate.png'"><xsl:text>cmd/32/insertpagenumberfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/updateall.png'"><xsl:text>cmd/32/reload.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/updateallindexes.png'"><xsl:text>cmd/32/insertmultiindex.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/updatealllinks.png'"><xsl:text>cmd/32/inserthyperlink.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/updatecharts.png'"><xsl:text>cmd/32/drawchart.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/updatecurindex.png'"><xsl:text>cmd/32/insertindexesentry.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/updatefields.png'"><xsl:text>cmd/32/addfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/updatemenu.png'"><xsl:text>cmd/32/reload.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_repaginate.png'"><xsl:text>cmd/lc_insertpagenumberfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_updateall.png'"><xsl:text>cmd/lc_reload.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_updateallindexes.png'"><xsl:text>cmd/lc_insertmultiindex.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_updatealllinks.png'"><xsl:text>cmd/lc_inserthyperlink.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_updatecharts.png'"><xsl:text>cmd/lc_drawchart.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_updatecurindex.png'"><xsl:text>cmd/lc_insertindexesentry.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_updatefields.png'"><xsl:text>cmd/lc_addfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_updatemenu.png'"><xsl:text>cmd/lc_reload.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_updatemenu.png'"><xsl:text>cmd/sc_reload.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/drawselect.png'"><xsl:text>cmd/32/selectobject.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/selectmode.png'"><xsl:text>cmd/32/selectobject.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/reportnavigator.png'"><xsl:text>cmd/32/navigator.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/dbdtableedit.png'"><xsl:text>cmd/32/dbtableedit.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/dbnewquerysql.png'"><xsl:text>cmd/32/sbanativesql.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/dbnewview.png'"><xsl:text>cmd/32/dbchangedesignmode.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/dbrelationdesign.png'"><xsl:text>cmd/32/dbaddrelation.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_dbdtableedit.png'"><xsl:text>cmd/lc_dbtableedit.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_dbrelationdesign.png'"><xsl:text>cmd/lc_dbaddrelation.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_dbdtableedit.png'"><xsl:text>cmd/sc_dbtableedit.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_dbrelationdesign.png'"><xsl:text>cmd/sc_dbaddrelation.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/browsebackward'"><xsl:text>cmd/32/prevrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/browseforward.png'"><xsl:text>cmd/32/nextrecord.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/macrodialog.png'"><xsl:text>cmd/32/scriptorganizer.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/macrosmenu.png'"><xsl:text>cmd/32/choosemacro.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/toolsmacroedit.png'"><xsl:text>cmd/32/basicideappear.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_macrodialog.png'"><xsl:text>cmd/lc_scriptorganizer.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_macrosmenu.png'"><xsl:text>cmd/lc_choosemacro.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_toolsmacroedit.png'"><xsl:text>cmd/lc_basicideappear.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_toolsmacroedit.png'"><xsl:text>cmd/sc_basicideappear.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/symbolcatalogue.png'"><xsl:text>cmd/32/insertsymbol.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/pluginsactive.png'"><xsl:text>cmd/32/insertplugin.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/inscellsctrl.png'"><xsl:text>cmd/32/inserttable.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/setoptimalcolumnwidthdirect.png'"><xsl:text>cmd/32/setoptimalcolumnwidth.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/starchartdialog.png'"><xsl:text>cmd/32/drawchart.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/tableautofitmenu.png'"><xsl:text>cmd/32/setoptimalrowheight.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/tabledeletemenu.png'"><xsl:text>cmd/32/deletetable.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/tableinsertmenu.png'"><xsl:text>cmd/32/insertrowsafter.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/tablemenu.png'"><xsl:text>cmd/32/inserttable.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/tableselectall.png'"><xsl:text>cmd/32/selecttable.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/tableselectmenu.png'"><xsl:text>cmd/32/selecttable.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_starchartdialog.png'"><xsl:text>cmd/lc_drawchart.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_tableautofitmenu.png'"><xsl:text>cmd/lc_setoptimalrowheight.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_tabledeletemenu.png'"><xsl:text>cmd/lc_deletetable.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_tableinsertmenu.png'"><xsl:text>cmd/lc_insertrowsafter.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_tablemenu.png'"><xsl:text>cmd/lc_inserttable.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_tableselectall.png'"><xsl:text>cmd/lc_selecttable.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_tableselectmenu.png'"><xsl:text>cmd/lc_selecttable.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_starchartdialog.png'"><xsl:text>cmd/sc_drawchart.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_tableautofitmenu.png'"><xsl:text>cmd/sc_setoptimalrowheight.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_tabledeletemenu.png'"><xsl:text>cmd/sc_deletetable.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_tableinsertmenu.png'"><xsl:text>cmd/sc_insertrowsafter.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_tableselectmenu.png'"><xsl:text>cmd/sc_selecttable.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/absoluterecord.png'"><xsl:text>cmd/32/helpindex.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/ar/bulletliststyle.png'"><xsl:text>cmd/32/ar/defaultbullet.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/ar/defaultparastyle.png'"><xsl:text>cmd/32/ar/controlcodes.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/ar/numberliststyle.png'"><xsl:text>cmd/32/ar/defaultnumbering.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ar/lc_bulletliststyle.png'"><xsl:text>cmd/ar/lc_defaultbullet.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ar/lc_defaultparastyle.png'"><xsl:text>cmd/ar/lc_controlcodes.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ar/lc_numberliststyle.png'"><xsl:text>cmd/ar/lc_defaultnumbering.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ar/sc_bulletliststyle.png'"><xsl:text>cmd/ar/sc_defaultbullet.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ar/sc_defaultparastyle.png'"><xsl:text>cmd/ar/sc_controlcodes.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ar/sc_numberliststyle.png'"><xsl:text>cmd/ar/sc_defaultnumbering.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/charbackcolor.png'"><xsl:text>cmd/32/backcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/setdefault.png'"><xsl:text>cmd/32/resetattributes.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/showgraphics.png'"><xsl:text>cmd/32/graphic.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_showgraphics.png'"><xsl:text>cmd/lc_graphic.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_showgraphics.png'"><xsl:text>cmd/sc_graphic.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/dsbdocumentdatasource.png'"><xsl:text>cmd/32/sbaexecutesql.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/dsbinsertcolumns.png'"><xsl:text>cmd/32/insertfieldctrl.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/inserttoolbox.png'"><xsl:text>cmd/32/dataimport.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/savesimple.png'"><xsl:text>cmd/32/save.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/sbabrwinsert.png'"><xsl:text>cmd/32/insertfieldctrl.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/showbrowser.png'"><xsl:text>cmd/32/controlproperties.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/showpropbrowser.png'"><xsl:text>cmd/32/controlproperties.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/ko/drawtext.png'"><xsl:text>cmd/32/ko/text.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/ko/fontcolor.png'"><xsl:text>cmd/32/ko/color.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/ko/formattextmenu.png'"><xsl:text>cmd/32/ko/text.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/ko/ordercrit.png'"><xsl:text>cmd/32/ko/datasort.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/ko/sortdown.png'"><xsl:text>cmd/32/ko/sortdescending.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/ko/sortup.png'"><xsl:text>cmd/32/ko/sortascending.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/ko/underlinesimple.png'"><xsl:text>cmd/32/ko/underline.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/ko/lc_drawtext.png'"><xsl:text>cmd/ko/lc_text.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ko/lc_fontcolor.png'"><xsl:text>cmd/ko/lc_color.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ko/lc_formattextmenu.png'"><xsl:text>cmd/ko/lc_text.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ko/lc_ordercrit.png'"><xsl:text>cmd/ko/lc_datasort.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ko/lc_sortdown.png'"><xsl:text>cmd/ko/lc_sortdescending.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ko/lc_sortup.png'"><xsl:text>cmd/ko/lc_sortascending.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ko/lc_underlinesimple.png'"><xsl:text>cmd/ko/lc_underline.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ko/sc_drawtext.png'"><xsl:text>cmd/ko/sc_text.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ko/sc_fontcolor.png'"><xsl:text>cmd/ko/sc_color.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ko/sc_formattextmenu.png'"><xsl:text>cmd/ko/sc_text.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ko/sc_ordercrit.png'"><xsl:text>cmd/ko/sc_datasort.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ko/sc_sortdown.png'"><xsl:text>cmd/ko/sc_sortdescending.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/ko/sc_sortup.png'"><xsl:text>cmd/ko/sc_sortascending.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/deleteslide.png'"><xsl:text>cmd/32/deletepage.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/duplicateslide.png'"><xsl:text>cmd/32/duplicatepage.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/firstslide.png'"><xsl:text>cmd/32/firstpage.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertdatefieldfix.png'"><xsl:text>cmd/32/datefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertdatefieldvar.png'"><xsl:text>cmd/32/datefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertpagefield.png'"><xsl:text>cmd/32/insertpagenumberfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertpagesfield.png'"><xsl:text>cmd/32/insertpagenumberfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertpagetitlefield.png'"><xsl:text>cmd/32/inserttitlefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertslide.png'"><xsl:text>cmd/32/insertpage.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertslidefield.png'"><xsl:text>cmd/32/insertpagenumberfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertslidenumber.png'"><xsl:text>cmd/32/insertpagenumberfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertslidesfield.png'"><xsl:text>cmd/32/insertpagecountfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertslidetitlefield.png'"><xsl:text>cmd/32/inserttitlefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/inserttimefieldfix.png'"><xsl:text>cmd/32/timefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/inserttimefieldvar.png'"><xsl:text>cmd/32/timefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/lastslide.png'"><xsl:text>cmd/32/lastrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/moveslidedown.png'"><xsl:text>cmd/32/downsearch.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/moveslidefirst.png'"><xsl:text>cmd/32/movepagefirst.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/moveslidelast.png'"><xsl:text>cmd/32/movepagelast.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/moveslideup.png'"><xsl:text>cmd/32/upsearch.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/nextslide.png'"><xsl:text>cmd/32/nextrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/previousslide.png'"><xsl:text>cmd/32/prevrecord.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/slidesetup.png'"><xsl:text>cmd/32/pagesetup.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_insertdatefieldfix.png'"><xsl:text>cmd/lc_datefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertdatefieldvar.png'"><xsl:text>cmd/lc_datefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertpagefield.png'"><xsl:text>cmd/lc_insertpagenumberfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertpagesfield.png'"><xsl:text>cmd/lc_insertpagenumberfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertpagetitlefield.png'"><xsl:text>cmd/lc_inserttitlefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertslide.png'"><xsl:text>cmd/lc_insertpage.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertslidefield.png'"><xsl:text>cmd/lc_insertpagenumberfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertslidenumber.png'"><xsl:text>cmd/lc_insertpagenumberfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertslidesfield.png'"><xsl:text>cmd/lc_insertpagecountfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertslidetitlefield.png'"><xsl:text>cmd/lc_inserttitlefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_inserttimefieldfix.png'"><xsl:text>cmd/lc_timefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_inserttimefieldvar.png'"><xsl:text>cmd/lc_timefield.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='dbaccess/res/form_16.png'"><xsl:text>cmd/sc_dbviewforms.png</xsl:text></xsl:when>
<xsl:when test="$src1='dbaccess/res/forms_16.png'"><xsl:text>res/dialogfolder_16.png</xsl:text></xsl:when>
<xsl:when test="$src1='dbaccess/res/forms_32.png'"><xsl:text>cmd/32/dbviewforms.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='dbaccess/res/queries_32.png'"><xsl:text>cmd/32/dbviewqueries.png</xsl:text></xsl:when>
<xsl:when test="$src1='dbaccess/res/reports_32.png'"><xsl:text>cmd/32/dbviewreports.png</xsl:text></xsl:when>
<xsl:when test="$src1='dbaccess/res/tables_32.png'"><xsl:text>cmd/32/dbviewtables.png</xsl:text></xsl:when>
<xsl:when test="$src1='dbaccess/res/jo01.png'"><xsl:text>dbaccess/res/pkey.png</xsl:text></xsl:when>
<xsl:when test="$src1='res/queries_32.png'"><xsl:text>cmd/32/dbviewqueries.png</xsl:text></xsl:when>
<xsl:when test="$src1='dbaccess/res/report_16.png'"><xsl:text>cmd/sc_dbviewreports.png</xsl:text></xsl:when>
<xsl:when test="$src1='dbaccess/res/reports_16.png'"><xsl:text>res/sx18013.png</xsl:text></xsl:when>
<xsl:when test="$src1='res/reports_32.png'"><xsl:text>cmd/32/dbviewreports.png</xsl:text></xsl:when>
<xsl:when test="$src1='dbaccess/res/sc036.png'"><xsl:text>cmd/sc_dbnewreport.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='res/tables_32.png'"><xsl:text>cmd/32/dbviewtables.png</xsl:text></xsl:when>
<xsl:when test="$src1='desktop/res/caution_16.png'"><xsl:text>dbaccess/res/exwarning.png</xsl:text></xsl:when>
<xsl:when test="$src1='desktop/res/extension_16.png'"><xsl:text>cmd/sc_insertplugin.png</xsl:text></xsl:when>
<xsl:when test="$src1='desktop/res/extension_32.png'"><xsl:text>cmd/32/insertplugin.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='reportdesign/res/report_16.png'"><xsl:text>cmd/sc_dbviewreports.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='reportdesign/res/sx12464.png'"><xsl:text>cmd/sc_dbviewreports.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='res/extension_plus_26.png'"><xsl:text>cmd/lc_insertplugin.png</xsl:text></xsl:when>
<xsl:when test="$src1='res/extension_plus_32.png'"><xsl:text>cmd/32/insertplugin.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='res/im30820.png'"><xsl:text>cmd/sc_scriptorganizer.png</xsl:text></xsl:when>
<xsl:when test="$src1='res/im30821.png'"><xsl:text>cmd/sc_choosemacro.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='res/sx10598.png'"><xsl:text>cmd/sc_formatgroup.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='res/sc05555.png'"><xsl:text>cmd/sc_stylenewbyexample.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='res/sc05554.png'"><xsl:text>cmd/sc_backgroundcolor.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='res/sc10868.png'"><xsl:text>cmd/sc_grafgamma.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='res/sx10597.png'"><xsl:text>cmd/sc_label.png</xsl:text></xsl:when>
<xsl:when test="$src1='res/sx10598.png'"><xsl:text>cmd/sc_groupbox.png</xsl:text></xsl:when>
<xsl:when test="$src1='res/sx10599.png'"><xsl:text>cmd/sc_text.png</xsl:text></xsl:when>
<xsl:when test="$src1='res/sx10600.png'"><xsl:text>cmd/sc_listbox.png</xsl:text></xsl:when>
<xsl:when test="$src1='res/sx10601.png'"><xsl:text>cmd/sc_combobox.png</xsl:text></xsl:when>
<xsl:when test="$src1='res/sx10603.png'"><xsl:text>cmd/sc_insertspreadsheet.png</xsl:text></xsl:when>
<xsl:when test="$src1='res/sx10604.png'"><xsl:text>cmd/sc_imagebutton.png</xsl:text></xsl:when>
<xsl:when test="$src1='res/sx10605.png'"><xsl:text>cmd/sc_filecontrol.png</xsl:text></xsl:when>
<xsl:when test="$src1='res/sx10607.png'"><xsl:text>cmd/sc_navigationbar.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='res/sx10706.png'"><xsl:text>cmd/sc_numberformatstandard.png</xsl:text></xsl:when>
<xsl:when test="$src1='res/sx10707.png'"><xsl:text>cmd/sc_currencyfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='res/sx10708.png'"><xsl:text>cmd/sc_patternfield.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='res/sx10769.png'"><xsl:text>cmd/sc_spinbutton.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='sc/res/nc06.png'"><xsl:text>cmd/sc_shownote.png</xsl:text></xsl:when>
<xsl:when test="$src1='sc/res/nc07.png'"><xsl:text>cmd/sc_insertbookmark.png</xsl:text></xsl:when>
<xsl:when test="$src1='sc/res/nc08.png'"><xsl:text>cmd/sc_insertgraphic.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='sd/res/displaymode_handoutmaster.png'"><xsl:text>cmd/32/handoutmode.png</xsl:text></xsl:when>
<xsl:when test="$src1='sd/res/displaymode_notes.png'"><xsl:text>cmd/32/notesmode.png</xsl:text></xsl:when>
<xsl:when test="$src1='sd/res/displaymode_notesmaster.png'"><xsl:text>cmd/32/notesmasterpage.png</xsl:text></xsl:when>
<xsl:when test="$src1='sd/res/displaymode_slide.png'"><xsl:text>cmd/32/normalmultipanegui.png</xsl:text></xsl:when>
<xsl:when test="$src1='sd/res/displaymode_slidemaster.png'"><xsl:text>cmd/32/slidemasterpage.png</xsl:text></xsl:when>
<xsl:when test="$src1='sd/res/displaymode_slidesorter.png'"><xsl:text>cmd/32/diamode.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='sd/res/group.png'"><xsl:text>cmd/sc_formatgroup.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='sfx2/res/actionview010.png'"><xsl:text>cmd/lc_dataimport.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='sfx2/res/symphony/sidebar-style-large.png'"><xsl:text>cmd/lc_designerdialog.png</xsl:text></xsl:when>
<xsl:when test="$src1='sfx2/res/symphony/sidebar-style-small.png'"><xsl:text>cmd/sc_designerdialog.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='svtools/res/new_doc.png'"><xsl:text>cmd/32/newdoc.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='svtools/res/template.png'"><xsl:text>cmd/32/templatemanager.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='svx/res/cd025.png'"><xsl:text>cmd/sc_autopilotmenu.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='svx/res/colordlg.png'"><xsl:text>cmd/sc_colorsettings.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='svx/res/id018.png'"><xsl:text>cmd/sc_choosemacro.png</xsl:text></xsl:when>
<xsl:when test="$src1='svx/res/id019.png'"><xsl:text>cmd/sc_modifyframe.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='svx/res/AdjustColorGamma_16x16.png'"><xsl:text>cmd/sc_grafgamma.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='svx/res/symphony/AdjustColorGamma_16x16.png'"><xsl:text>cmd/sc_grafgamma.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='svx/res/symphony/fill_color.png'"><xsl:text>cmd/sc_backgroundcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='svx/res/symphony/rotate_left.png'"><xsl:text>cmd/sc_rotateleft.png</xsl:text></xsl:when>
<xsl:when test="$src1='svx/res/symphony/rotate_right.png'"><xsl:text>cmd/sc_rotateright.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='sw/res/nc20003.png'"><xsl:text>cmd/sc_insertgraphic.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='sw/res/nc20010.png'"><xsl:text>cmd/sc_shownote.png</xsl:text></xsl:when>
<xsl:when test="$src1='sw/res/nc20011.png'"><xsl:text>cmd/sc_insertdraw.png</xsl:text></xsl:when>
<xsl:when test="$src1='sw/res/sc20244.png'"><xsl:text>sw/res/sc20234.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='sw/res/sc20182.png'"><xsl:text>cmd/sc_toggleanchortype.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='sw/res/sidebar/pageproppanel/last_custom_common.png'"><xsl:text>svx/res/symphony/last_custom_common.png</xsl:text></xsl:when>
<xsl:when test="$src1='sw/res/sidebar/pageproppanel/last_custom_common_grey.png'"><xsl:text>svx/res/symphony/last_custom_common_grey.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='sw/res/sr20005.png'"><xsl:text>cmd/sc_insertdraw.png</xsl:text></xsl:when>
<xsl:when test="$src1='sw/res/sr20006.png'"><xsl:text>cmd/sc_choosecontrols.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='sw/res/sr20009.png'"><xsl:text>cmd/sc_insertgraphic.png</xsl:text></xsl:when>
<xsl:when test="$src1='sw/res/sr20010.png'"><xsl:text>cmd/sc_insertobject.png</xsl:text></xsl:when>
<xsl:when test="$src1='sw/res/sr20011.png'"><xsl:text>sw/res/nc20000.png</xsl:text></xsl:when>
<xsl:when test="$src1='sw/res/sr20013.png'"><xsl:text>cmd/sc_insertfootnote.png</xsl:text></xsl:when>
<xsl:when test="$src1='sw/res/sr20014.png'"><xsl:text>sw/res/sc20183.png</xsl:text></xsl:when>
<xsl:when test="$src1='sw/res/sr20015.png'"><xsl:text>cmd/sc_shownote.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='sw/res/sx01.png'"><xsl:text>cmd/sc_changedatabasefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='sw/res/sx02.png'"><xsl:text>cmd/sc_freezepanesfirstrow.png</xsl:text></xsl:when>
<xsl:when test="$src1='sw/res/sx03.png'"><xsl:text>cmd/sc_dbviewqueries.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/wrapmenu.png'"><xsl:text>cmd/32/wrapon.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_wrapmenu.png'"><xsl:text>cmd/lc_wrapon.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_wrapmenu.png'"><xsl:text>cmd/sc_wrapon.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/columnoperations.png'"><xsl:text>cmd/32/entirecolumn.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/rowoperations.png'"><xsl:text>cmd/32/entirerow.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_toolprotectiondocument.png'"><xsl:text>cmd/sc_protect.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_toolprotectiondocument.png'"><xsl:text>cmd/lc_protect.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/renametable.png'"><xsl:text>cmd/32/name.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/settabbgcolor.png'"><xsl:text>cmd/32/backgroundcolor.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/sheetrighttoleft.png'"><xsl:text>cmd/32/pararighttoleft.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/tabledeselectall.png'"><xsl:text>cmd/32/dbviewtablenames.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/tableevents.png'"><xsl:text>cmd/32/animationeffects.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_renametable.png'"><xsl:text>cmd/lc_name.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_tableselectall.png'"><xsl:text>cmd/lc_selecttable.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_renametable.png'"><xsl:text>cmd/sc_name.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_tableselectall.png'"><xsl:text>cmd/sc_selecttable.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/columnwidth.png'"><xsl:text>cmd/32/setminimalcolumnwidth.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/rowheight.png'"><xsl:text>cmd/32/setminimalrowheight.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_columnwidth.png'"><xsl:text>cmd/lc_setminimalcolumnwidth.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_rowheight.png'"><xsl:text>cmd/lc_setminimalrowheight.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_columnwidth.png'"><xsl:text>cmd/sc_setminimalcolumnwidth.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_rowheight.png'"><xsl:text>cmd/sc_setminimalrowheight.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/exportasgraphic.png'"><xsl:text>cmd/32/insertgraphic.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/margins.png'"><xsl:text>cmd/32/pagemargin.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/namegroup.png'"><xsl:text>cmd/32/definename.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_namegroup.png'"><xsl:text>cmd/lc_definename.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_namegroup.png'"><xsl:text>cmd/sc_definename.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/assignmacro.png'"><xsl:text>cmd/32/starshapes.vertical-scroll.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/convertmenu.png'"><xsl:text>cmd/32/bezierconvert.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/deleteshapehyperlink.png'"><xsl:text>cmd/32/removehyperlink.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/editshapehyperlink.png'"><xsl:text>cmd/32/inserthyperlink.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/mirrormenu.png'"><xsl:text>cmd/32/rotateleft.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/openhyperlinkoncursor.png'"><xsl:text>cmd/32/inserthyperlink.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/rotateflipmenu.png'"><xsl:text>cmd/32/rotateleft.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_assignmacro.png'"><xsl:text>cmd/lc_starshapes.vertical-scroll.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_convertmenu.png'"><xsl:text>cmd/lc_bezierconvert.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_mirrormenu.png'"><xsl:text>cmd/lc_rotateleft.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_openhyperlinkoncursor.png'"><xsl:text>cmd/lc_inserthyperlink.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_rotateflipmenu.png'"><xsl:text>cmd/lc_rotateleft.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_mirrormenu.png'"><xsl:text>cmd/sc_rotateleft.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_convertmenu.png'"><xsl:text>cmd/sc_bezierconvert.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/chartmenu.png'"><xsl:text>cmd/32/drawchart.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/objectmenu.png'"><xsl:text>cmd/32/insertframe.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_chartmenu.png'"><xsl:text>cmd/lc_drawchart.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_objectmenu.png'"><xsl:text>cmd/lc_insertframe.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/addtextbox.png'"><xsl:text>cmd/32/insertfixedtext.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/openxmlfiltersettings.png'"><xsl:text>cmd/32/managexmlsource.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_addtextbox.png'"><xsl:text>cmd/lc_insertfixedtext.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_openxmlfiltersettings.png'"><xsl:text>cmd/lc_managexmlsource.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_addtextbox.png'"><xsl:text>cmd/sc_insertfixedtext.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_openxmlfiltersettings.png'"><xsl:text>cmd/sc_managexmlsource.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/textformfield.png'"><xsl:text>cmd/32/edit.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/checkboxformfield.png'"><xsl:text>cmd/32/checkbox.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/dropdownformfield.png'"><xsl:text>cmd/32/combobox.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/datepickerformfield.png'"><xsl:text>cmd/32/datefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_textformfield.png'"><xsl:text>cmd/lc_edit.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_checkboxformfield.png'"><xsl:text>cmd/lc_checkbox.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_dropdownformfield.png'"><xsl:text>cmd/lc_combobox.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_datepickerformfield.png'"><xsl:text>cmd/lc_datefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_textformfield.png'"><xsl:text>cmd/sc_edit.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_checkboxformfield.png'"><xsl:text>cmd/sc_checkbox.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_dropdownformfield.png'"><xsl:text>cmd/sc_combobox.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_datepickerformfield.png'"><xsl:text>cmd/sc_datefield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/selectcolumn.png'"><xsl:text>cmd/32/entirecolumn.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/selectdata.png'"><xsl:text>cmd/32/selectdb.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/selectrow.png'"><xsl:text>cmd/32/entirerow.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/sheetlefttoright.png'"><xsl:text>cmd/32/paralefttoright.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/sheetrighttoleft.png'"><xsl:text>cmd/32/pararighttoleft.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/tableevents.png'"><xsl:text>cmd/32/animationeffects.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_selectcolumn.png'"><xsl:text>cmd/lc_entirecolumn.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_selectdata.png'"><xsl:text>cmd/lc_selectdb.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_selectrow.png'"><xsl:text>cmd/lc_entirerow.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_sheetlefttoright.png'"><xsl:text>cmd/lc_paralefttoright.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_sheetrighttoleft.png'"><xsl:text>cmd/lc_pararighttoleft.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_tableevents.png'"><xsl:text>cmd/lc_animationeffects.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_selectcolumn.png'"><xsl:text>cmd/sc_entirecolumn.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_selectdata.png'"><xsl:text>cmd/sc_selectdb.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_selectrow.png'"><xsl:text>cmd/sc_entirerow.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_sheetlefttoright.png'"><xsl:text>cmd/sc_paralefttoright.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_sheetrighttoleft.png'"><xsl:text>cmd/sc_pararighttoleft.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_tableevents.png'"><xsl:text>cmd/sc_animationeffects.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/donation.png'"><xsl:text>cmd/32/currencyfield.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/macrosmenu.png'"><xsl:text>cmd/32/choosemacro.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_macrosmenu.png'"><xsl:text>cmd/sc_choosemacro.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/badcellstyles.png'"><xsl:text>cmd/32/badcellstyle.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/defaultcellstyles.png'"><xsl:text>cmd/32/defaultcharstyle.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/footnotecellstyles.png'"><xsl:text>cmd/32/insertfootnote.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/goodcellstyles.png'"><xsl:text>cmd/32/goodcellstyle.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/heading1cellstyles.png'"><xsl:text>cmd/32/heading1parastyle.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/heading2cellstyles.png'"><xsl:text>cmd/32/heading2parastyle.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/neutralcellstyles.png'"><xsl:text>cmd/32/neutralcellstyle.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/notecellstyles.png'"><xsl:text>cmd/32/showannotations.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_badcellstyles.png'"><xsl:text>cmd/lc_badcellstyle.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_goodcellstyles.png'"><xsl:text>cmd/lc_goodcellstyle.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_neutralcellstyles.png'"><xsl:text>cmd/lc_neutralcellstyle.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/32/com.sun.star.deployment.ui.packagemanagerdialog.png'"><xsl:text>cmd/32/insertplugin.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/focustofindbar.png'"><xsl:text>cmd/32/recsearch.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/formatobjectmenu.png'"><xsl:text>cmd/32/text.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/macroorganizer%3ftabid%3ashort=1.png'"><xsl:text>cmd/32/open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/textattributes.png'"><xsl:text>cmd/32/fontdialog.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_com.sun.star.deployment.ui.packagemanagerdialog.png'"><xsl:text>cmd/lc_insertplugin.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_focustofindbar.png'"><xsl:text>cmd/lc_recsearch.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_formatobjectmenu.png'"><xsl:text>cmd/lc_text.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_macroorganizer%3ftabid%3ashort=1.png'"><xsl:text>cmd/lc_open.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_textattributes.png'"><xsl:text>cmd/lc_fontdialog.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/sc_textattributes.png'"><xsl:text>cmd/sc_fontdialog.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/editpastespecialmenu.png'"><xsl:text>cmd/32/pastespecial.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/insertcontents.png'"><xsl:text>cmd/32/pastespecial.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/32/pastespecialmenu.png'"><xsl:text>cmd/32/pastespecial.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_editpastespecialmenu.png'"><xsl:text>cmd/lc_pastespecial.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_insertcontents.png'"><xsl:text>cmd/lc_pastespecial.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/lc_pastespecialmenu.png'"><xsl:text>cmd/lc_pastespecial.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_editpastespecialmenu.png'"><xsl:text>cmd/sc_pastespecial.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_insertcontents.png'"><xsl:text>cmd/sc_pastespecial.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_pastespecialmenu.png'"><xsl:text>cmd/sc_pastespecial.png</xsl:text></xsl:when>
