...
<xsl:when test="$src1='cmd/sc_sheetcommentmenu.png'"><xsl:text>cmd/sc_shownote.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='sd/res/graphic.png'"><xsl:text>cmd/sc_insertgraphic.png</xsl:text></xsl:when>
<xsl:when test="$src1='sd/res/breakplayingblue_16.png'"><xsl:text>cmd/sc_mediapause.png</xsl:text></xsl:when>
<xsl:when test="$src1='sd/res/comments_indicator.png'"><xsl:text>cmd/sc_shownote.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='cmd/lc_notecellstyles.png'"><xsl:text>cmd/lc_shownote.png</xsl:text></xsl:when>
<xsl:when test="$src1='cmd/sc_notecellstyles.png'"><xsl:text>cmd/sc_shownote.png</xsl:text></xsl:when>
