...
<xsl:when test="$src1='sw/res/nc20002.png'"><xsl:text>cmd/sc_text.png</xsl:text></xsl:when>
...
<xsl:when test="$src1='sw/res/sr20003.png'"><xsl:text>cmd/sc_text.png</xsl:text></xsl:when>
