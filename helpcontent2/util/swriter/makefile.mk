...
#*    last change       $Author: fpe $ $Date: 2004-08-18 10:59:46 $
#*
#*    $Revision: 1.1 $
#*
#*    $Logfile:$
...
LINKADDEDFILES= \
   ...
   -add help$/LANGUAGE$/swriter.jar  $(BIN)$/swriter_xml_LANGUAGE.zip


LINKADDEDDEPS= \
   $(PRJ)$/source$/auxiliary$/LANGUAGE$/swriter.cfg \
   $(PRJ)$/source$/auxiliary$/LANGUAGE$/swriter.tree \
   $(BIN)$/swriter_xml_LANGUAGE.zip
...
LINKLINKFILES= \
   ...
   text$/swriter$/guide$/fontwork.hzip \
   ...
   text$/swriter$/guide$/text_along_line.hzip \
