...
'
    ...
    for item in filters:
        ...
        <tablerow>\n\
            <tablecell>\n\
                <paragraph role="paragraph" id="FilterName_{uid}">{item[0]}</paragraph>\n\
            </tablecell>\n\
            <tablecell>\n\
                <paragraph role="paragraph" id="APIName_{uid}" localize="false">{item[1]}</paragraph>\n\
            </tablecell>\n\
            <tablecell>\n\
                <paragraph role="paragraph" id="MediaType_{uid}" localize="false">{item[2]}</paragraph>\n\
            </tablecell>\n\
            <tablecell>\n\
                <paragraph role="paragraph" id="Extenstion_{uid}" localize="false">{item[3]}</paragraph>\n\
            </tablecell>\n\
        </tablerow>\n'
